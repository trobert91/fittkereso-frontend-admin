...
export function CategoryTable() {
  ...
  const columns = useMemo(
    () => [
      ...
      columnHelper.accessor("extractionEnabled", {
        ...
        cell: (props) => (
          <Badge color={props.getValue() ? "blue" : "gray"} size="sm" variant="filled">
            {props.getValue() ? "Yes" : "No"}
          </Badge>
        ),
      }),

      columnHelper.accessor("searchEnabled", {
        id: "searchEnabled",
        enableSorting: true,
        header: ({ column }) => (
          <Text
        ...
        cell: (props) => (
          <Badge color={props.getValue() ? "violet" : "gray"} size="sm" variant="filled">
            {props.getValue() ? "Yes" : "No"}
          </Badge>
        ),
      }),

      columnHelper.accessor("autoDeduplicationEnabled", {
        id: "autoDeduplicationEnabled",
        enableSorting: false,
        header: () => (
          <Text fw={500}>
            Dedup
        ...
        cell: (props) => (
          <Badge color={props.getValue() ? "teal" : "gray"} size="sm" variant="filled">
            {props.getValue() ? "Yes" : "No"}
          </Badge>
        ),
      }),

      columnHelper.accessor("searchPriority", {
        id: "searchPriority",
        enableSorting: true,
        header: ({ column }) => (
          <Text
